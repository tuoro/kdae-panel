import{q as N,S as E,y as p,v as H,d as O,p as b,a9 as V,ao as j,a5 as A,E as F,F as w,H as k,O as L,ap as y}from"./index-DQLNKWAW.js";let S=!1;function T(){if(N&&window.CSS&&!S&&(S=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function $(e){const{heightSmall:i,heightMedium:r,heightLarge:s,borderRadius:a}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:a,heightSmall:i,heightMedium:r,heightLarge:s}}const q={common:E,self:$},I=p([H("skeleton",`
 height: 1em;
 width: 100%;
 transition:
