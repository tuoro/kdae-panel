import{B as e,Bn as t,Cn as n,D as r,Dn as i,F as a,Fn as o,Gt as s,H as c,Ht as l,In as u,Jt as d,Kt as f,L as p,Mn as m,N as h,Nn as g,Q as _,R as v,T as y,V as b,Vn as x,Vt as S,W as C,Wt as w,Yt as ee,Z as T,Zn as E,_n as D,an as O,ar as k,dn as A,et as j,fn as M,gn as N,hn as P,i as te,ir as F,j as ne,jn as I,kn as re,ln as L,lt as R,or as z,ot as B,p as V,pn as H,qt as ie,rr as U,tr as W,tt as G,un as K,v as ae,xn as q,yn as J,z as oe,zn as se}from"./client-DxGwbE0G.js";import{o as ce,t as le}from"./create-UzcjT6JE.js";import{f as ue,l as de,o as fe,r as pe,t as me}from"./Scrollbar-D7sZ6UbX.js";import{t as he}from"./misc-DDs3MKLt.js";import{d as ge,i as Y}from"./event-BjBdMN5Y.js";import{t as _e}from"./use-merged-state-BQsEeq0P.js";import{i as ve,n as ye,r as be,t as xe}from"./text-BeGXUzaC.js";import{a as Se,n as Ce,r as we,t as Te}from"./useMobileViewport-DprhGzqY.js";import{t as Ee}from"./fade-in-height-expand.cssr-B7vg5ZyK.js";import{n as De}from"./Tag-ChiMQ9Gi.js";import{t as Oe}from"./Alert-47B0grK_.js";import{t as X}from"./Icon-CvrbkbkZ.js";import{n as ke,t as Ae}from"./DrawerContent-DEPFk2tJ.js";import{i as je,k as Me,l as Ne,n as Pe,r as Fe,t as Ie}from"./index-BK6ZBEpV.js";import{t as Le}from"./SwapHorizontalOutline-DM4lu-We.js";import{t as Re}from"./PanelUpdateAction-BWKUf8SA.js";var ze=ae&&`loading`in document.createElement(`img`);function Be(e={}){let{root:t=null}=e;return{hash:`${e.rootMargin||`0px 0px 0px 0px`}-${Array.isArray(e.threshold)?e.threshold.join(`,`):e.threshold??`0`}`,options:{...e,root:(typeof t==`string`?document.querySelector(t):t)||document.documentElement}}}var Ve=new WeakMap,He=new WeakMap,Ue=new WeakMap,We=(e,t,n)=>{if(!e)return()=>{};let r=Be(t),{root:i}=r.options,a,o=Ve.get(i);o?a=o:(a=new Map,Ve.set(i,a));let s,c;a.has(r.hash)?(c=a.get(r.hash),c[1].has(e)||(s=c[0],c[1].add(e),s.observe(e))):(s=new IntersectionObserver(e=>{e.forEach(e=>{if(e.isIntersecting){let t=He.get(e.target),n=Ue.get(e.target);t&&t(),n&&(n.value=!0)}})},r.options),s.observe(e),c=[s,new Set([e])],a.set(r.hash,c));let l=!1,u=()=>{l||(He.delete(e),Ue.delete(e),l=!0,c[1].has(e)&&(c[0].unobserve(e),c[1].delete(e)),c[1].size<=0&&a.delete(r.hash),a.size||Ve.delete(i))};return He.set(e,u),Ue.set(e,n),u},Ge=R(`n-avatar-group`),Ke=l(`avatar`,`
