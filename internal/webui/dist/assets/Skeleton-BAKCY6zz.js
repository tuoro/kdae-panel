import{p as _,R as E,x as v,s as H,d as O,n as b,a8 as V,ao as j,a4 as A,D as L,E as w,G as k,N as T,ap as y}from"./index-98BUdM3h.js";let S=!1;function $(){if(_&&window.CSS&&!S&&(S=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function D(e){const{heightSmall:i,heightMedium:r,heightLarge:s,borderRadius:a}=e;return{color:"#eee",colorEnd:"#ddd",borderRadius:a,heightSmall:i,heightMedium:r,heightLarge:s}}const F={common:E,self:D},G=v([H("skeleton",`
 height: 1em;
 width: 100%;
 transition:
