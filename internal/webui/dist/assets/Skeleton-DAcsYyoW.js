import{B as e,Cn as t,H as n,Ht as r,Vt as i,X as a,_n as o,an as s,jn as c,ln as l,ot as u,pn as d,qt as f,tt as p,v as m,yn as h}from"./client-DxGwbE0G.js";import{n as g}from"./misc-DDs3MKLt.js";var _=!1;function v(){if(m&&window.CSS&&!_&&(_=!0,`registerProperty`in window?.CSS))try{CSS.registerProperty({name:`--n-color-start`,syntax:`<color>`,inherits:!1,initialValue:`#0000`}),CSS.registerProperty({name:`--n-color-end`,syntax:`<color>`,inherits:!1,initialValue:`#0000`})}catch{}}function y(e){let{heightSmall:t,heightMedium:n,heightLarge:r,borderRadius:i}=e;return{color:`#eee`,colorEnd:`#ddd`,borderRadius:i,heightSmall:t,heightMedium:n,heightLarge:r}}var b={name:`Skeleton`,common:n,self:y},x=i([r(`skeleton`,`
 height: 1em;
 width: 100%;
 transition:
