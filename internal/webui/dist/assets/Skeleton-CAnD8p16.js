import{An as e,En as t,Gt as n,Jt as r,Mt as i,Yt as a,en as o,fn as s,gn as c,j as l,pt as u,wn as d,x as f}from"./client-Bvr5b7kq.js";import{n as p}from"./misc-DDs3MKLt.js";var m=!1;function h(){if(i&&window.CSS&&!m&&(m=!0,`registerProperty`in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:`--n-color-start`,syntax:`<color>`,inherits:!1,initialValue:`#0000`}),CSS.registerProperty({name:`--n-color-end`,syntax:`<color>`,inherits:!1,initialValue:`#0000`})}catch{}}function g(e){let{heightSmall:t,heightMedium:n,heightLarge:r,borderRadius:i}=e;return{color:`#eee`,colorEnd:`#ddd`,borderRadius:i,heightSmall:t,heightMedium:n,heightLarge:r}}var _={name:`Skeleton`,common:f,self:g},v=r([a(`skeleton`,`
 height: 1em;
 width: 100%;
 transition:
