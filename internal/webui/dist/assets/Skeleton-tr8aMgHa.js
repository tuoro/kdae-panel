import{$ as e,An as t,En as n,In as r,Mn as i,Sn as a,Wn as o,Y as s,en as c,on as l,pt as u,st as d,tn as f,v as p,vn as m,vt as h}from"./client-BDSaduAi.js";import{n as g}from"./misc-DDs3MKLt.js";var _=!1;function v(){if(p&&window.CSS&&!_&&(_=!0,`registerProperty`in window?.CSS))try{CSS.registerProperty({name:`--n-color-start`,syntax:`<color>`,inherits:!1,initialValue:`#0000`}),CSS.registerProperty({name:`--n-color-end`,syntax:`<color>`,inherits:!1,initialValue:`#0000`})}catch{}}function y(e){let{heightSmall:t,heightMedium:n,heightLarge:r,borderRadius:i}=e;return{color:`#eee`,colorEnd:`#ddd`,borderRadius:i,heightSmall:t,heightMedium:n,heightLarge:r}}var b={name:`Skeleton`,common:e,self:y},x=c([f(`skeleton`,`
 height: 1em;
 width: 100%;
 transition:
