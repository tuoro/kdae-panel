...
`,[c(`strong`,`
 ...
 position: relative;
 fill: currentColor;
`,[c(`color-transition`,{transition:`color .3s var(--n-bezier)`}),c(`depth`,{color:`var(--n-color)`},[a(`svg`,{opacity:`var(--n-opacity)`,transition:`opacity .3s var(--n-bezier)`})]),a(`svg`,{height:`1em`,width:`1em`})]),L=Object.assign(Object.assign({},v.props),{depth:[String,Number],size:[Number,String],color:String,component:[Object,Function]}),R=b({_n_icon__:!0,name:`Icon`,inheritAttrs:!1,props:L,setup(e){let{mergedClsPrefixRef:t,inlineThemeDisabled:n}=y(e),r=v(`Icon`,`-icon`,I,D,e,t),i=g(()=>{let{depth:t}=e,{common:{cubicBezierEaseInOut:n},self:i}=r.value;if(t!==void 0){let{color:e,[`opacity${t}Depth`]:r}=i;return{"--n-bezier":n,"--n-color":e,"--n-opacity":r}}return{"--n-bezier":n,"--n-color":``,"--n-opacity":``}}),a=n?h(`icon`,g(()=>`${e.depth||`d`}`),i,e):void 0;return{mergedClsPrefix:t,mergedStyle:g(()=>{let{size:t,color:n}=e;return{fontSize:T(t),color:n}}),cssVars:n?void 0:i,themeClass:a?.themeClass,onRender:a?.onRender}},render(){let{$parent:e,depth:n,mergedClsPrefix:a,component:o,onRender:s,themeClass:c}=this;return e?.$options?._n_icon__&&i(`icon`,"don't wrap `n-icon` inside `n-icon`"),s?.(),r(`i`,t(this.$attrs,{role:`img`,class:[`${a}-icon`,c,{[`${a}-icon--depth`]:n,[`${a}-icon--color-transition`]:n!==void 0}],style:[this.cssVars,this.mergedStyle]}),o?r(o):this.$slots)}});export{F as n,P as r,R as t};